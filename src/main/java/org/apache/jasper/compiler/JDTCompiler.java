    ...
    protected void generateClass(String[] smap)
        ...
        if(ctxt.getOptions().getCompilerSourceVM() != null) {
            ...
            if(opt.equals("1.1")) {
                ...
                settings.put(CompilerOptions.OPTION_Source,"1.6");
        ...
        if(ctxt.getOptions().getCompilerTargetVM() != null) {
            ...
            if(opt.equals("1.1")) {
                ...
                settings.put(CompilerOptions.OPTION_TargetPlatform,"1.6");
                settings.put(CompilerOptions.OPTION_Compliance,"1.6");
            } else if(opt.equals("1.7")) {
                settings.put(CompilerOptions.OPTION_TargetPlatform,"1.7");
